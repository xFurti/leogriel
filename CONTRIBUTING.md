...
We follow [Semantic Versioning](https://semver.org/). All workspace packages are kept at the same version (currently **0.5.0**). Update `CHANGELOG.md` under `[Unreleased]` or the next version section.
