...
This skill targets **skillctl 0.9.0**. Lock schema remains 1.0 and config remains version 1. Older locks remain readable, but legacy mutable remote entries require `update`, and pre-0.6 local/global project paths should be re-added or re-imported into the project store.
