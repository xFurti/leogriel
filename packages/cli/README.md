...
Leogriel weaves [Agent Skills](https://agentskills.io) into every workflow with reproducible discovery, installation, synchronization, audit, and testing. v0.9.0 adds experimental paired behavioral testing with an isolated Codex runner while retaining the 0.8 lock-compatible parser, backup, audit, artifact, and redaction foundations.
