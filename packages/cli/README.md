...
Leogriel weaves [Agent Skills](https://agentskills.io) into every workflow with reproducible discovery, installation, synchronization, audit, and testing. The `1.0.0-beta.4` candidate consolidates Git-ref regression comparison, optional GitHub-native reports, complete first-party JSON contracts, and a second experimental Claude Code runner alongside the isolated Codex runner.
