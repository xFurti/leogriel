window.TRANSLATIONS = {
  it: {
    nav: {
      brandSub: 'Documentazione v1.0.0-beta.4',
      navSection: 'Guida',
...
<section class="hero">
  ...
  <div class="hero-content">
    <p class="hero-badge">v1.0.0-beta.4 · Agent Skills</p>
...
<div class="alert alert-info">
  <strong>Versione 1.0.0-beta.4</strong> — npm <code>@leogriel/cli@1.0.0-beta.4</code>
...
<footer class="page-footer">
  leogriel v1.0.0-beta.4 — creato da <a href="https://github.com/xFurti" target="_blank" rel="noopener">xFurti</a> e <a href="https://github.com/gabry848" target="_blank" rel="noopener">Gabry848</a><br>
...
<p>Il dry-run verifica versione, publisher, tarball/SRI, entrypoint, API, capability, dipendenze, script e attendibilità senza installare. Le capability sono dichiarazioni, non permessi.</p>
...
<div class="alert alert-warn"><strong>Isolamento</strong> Riduce il caricamento di configurazioni personali ma non è una sandbox assoluta. I workspace conservati possono contenere output sensibili.</div>
...
<p>I contratti candidati alla RC, la migrazione bilingue e la matrice di prove esterne sono documentati in <code>docs/public-contracts.md</code>, <code>docs/migration-1.0.md</code> e <code>docs/validation-matrix.md</code>. Non dichiarano stabile la beta corrente.</p>
...
`,
      ...
      commands: {
        ...
        html: `
<h1>Comandi CLI</h1>
<p class="lead">Riferimento completo ai comandi leogriel v1.0.0-beta.4. I blocchi comando restano in inglese come nell'interfaccia CLI.</p>
...
`,
  ...
  en: {
    nav: {
      brandSub: 'Documentation v1.0.0-beta.4',
      navSection: 'Guide',
...
<div class="alert alert-info">
  <strong>Version 1.0.0-beta.4</strong> — npm <code>@leogriel/cli@1.0.0-beta.4</code>
...
<footer class="page-footer">
  leogriel v1.0.0-beta.4 — created by <a href="https://github.com/xFurti" target="_blank" rel="noopener">xFurti</a> and <a href="https://github.com/gabry848" target="_blank" rel="noopener">Gabry848</a><br>
...
<p>RC contract candidates, the bilingual migration guide, and the external evidence matrix are documented in <code>docs/public-contracts.md</code>, <code>docs/migration-1.0.md</code>, and <code>docs/validation-matrix.md</code>. They do not declare the current beta stable.</p>
...
`,
      ...
      commands: {
        ...
        html: `
<h1>CLI commands</h1>
<p class="lead">Complete reference for leogriel v1.0.0-beta.4 commands. Command blocks remain in English as in the CLI interface.</p>
